...
If you find a security vulnerability in Test Game, please report it through [GitHub's private vulnerability reporting](https://github.com/space-ducks/test-game/security/advisories/new). This keeps the details private while we work on a fix.
